...
def home_view(request):
    ...
    return render(request, 'sitecore/home.html', context)
...
def about_view(request):
    ...
    return render(request, 'sitecore/about.html', context)
...
def contact_view(request):
    ...
    return render(request, 'sitecore/contact.html', context)


def unauthorized_view(request):
    """Unauthorized access page"""
    return render(request, 'sitecore/unauthorized.html')
